...
class Terminals
  ...
  def terminalsProcess
    ...
    data.each do |line|
      terminal = line['ter_termial']

      idd = line['ter_id_terminal']
      if '' == idd
        idd = terminal
      end
      ...
      region = line['dep_region']
      if '' == region
        region = sity
      end

      street_type = line['dep_street_type']
      street = line['dep_street']

      house = line['dep_hous']

      serial = line['ter_serial_number']
      fiscal = line['ter_fiscal_number']
