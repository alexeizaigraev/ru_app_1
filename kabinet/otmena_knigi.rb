...
class OtmenaKnigi < Papa2
    include Modules

  def otmenaKnigiProcess
...
<HFILL>#{now_date_kabinet()}</HFILL>
    ...
    ofname = kabinet_out_dir + 'otmenaKnigi_' + insert_data['fiscal_number'] + '_' + insert_data['serial_number'] + '.xml'
